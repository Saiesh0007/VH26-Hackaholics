...
class AppColors {
  ...
  static const Color pastelBlue =
      Color(0xFF60A5FA); // Radiant signature pastel blue
  static const Color pastelAzure =
      Color(0xFF38BDF8); // Crisp vibrant pastel cyan-blue
  static const Color pastelDenim =
      Color(0xFF3B82F6); // Rich medium pastel cobalt
  ...
  static const Color accentBlue =
      Color(0xFF38BDF8); // Electric soft cyan accent

  // Geometry & Radii
  static const BorderRadius pillRadius = BorderRadius.all(Radius.circular(6));
  static const BorderRadius cardRadius = BorderRadius.all(Radius.circular(7));
  ...
  static const Color background =
      Color(0xFF091020); // Deepest midnight pastel navy
  static const Color surface =
      Color(0xFF0F1B35); // Rich dark pastel blue container
  static const Color surfaceElevated =
      Color(0xFF17284C); // Elevated card / button surface
  static const Color surfaceHover =
      Color(0xFF1E3563); // Interactive hover state
  static const Color cardBorder =
      Color(0xFF233C6E); // Translucent slate-blue border
  static const Color divider =
      Color(0xFF162544); // Dark pastel navy hairline divider
  ...
  static const Color textSecondary =
      Color(0xFFBFDBFE); // Frosted light pastel blue
