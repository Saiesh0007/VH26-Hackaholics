...
class _WhatIfScreenState extends ConsumerState<WhatIfScreen> {
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      const Text('Projected Traffic Rate', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: AppColors.textPrimary)),
                      Text('${_trafficRate.toInt()} events/min', style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w800, color: AppColors.primaryLight)),
                    ],
                  ),
                  Slider(
                    value: _trafficRate,
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      const Text('Worker Nodes', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: AppColors.textPrimary)),
                      Text('$_workers workers', style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w800, color: AppColors.primaryLight)),
                    ],
                  ),
                  Slider(
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      const Text('Batch Size Threshold', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: AppColors.textPrimary)),
                      Text('$_batchSize items', style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w800, color: AppColors.primaryLight)),
                    ],
                  ),
                  Slider(
  ...
  TableRow _comparisonRow(String label, String current, String predicted, {bool highlight = false, bool isHealthy = false}) {
    return TableRow(
      children: [
        Padding(
          padding: const EdgeInsets.symmetric(vertical: 8, horizontal: 8),
        ...
        Padding(
          ...
          child: Text(
            ...
            style: TextStyle(
              ...
              color: isHealthy ? AppColors.healthy : (highlight ? AppColors.primaryLight : AppColors.textPrimary),
            ),
          ),
        ),
      ],
