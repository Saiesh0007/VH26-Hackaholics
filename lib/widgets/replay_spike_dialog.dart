...
class ReplaySpikeDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final maxWidth = (viewport.width - 32).clamp(0.0, 620.0).toDouble();
            ...
            children: [
              ...
              Table(
                ...
                children: [
                  ...
                  _metricRow('P0 Latency (Critical)', '4,850 ms (Breached)',
                      '38.5 ms (Guaranteed)',
                      isBetter: true),
                  _metricRow('P1 Latency', '14,200 ms', '58.0 ms',
                      isBetter: true),
                  _metricRow('P2 Latency', '38,000 ms', '175.0 ms',
                      isBetter: true),
                  _metricRow('P3 Latency', '72,000 ms', '420.0 ms',
                      isBetter: true),
                  _metricRow('Critical Events Dropped', '3,680 (18.4%)',
                      '0 DROPPED (0.0%)',
                      isBetter: true, isCriticalMetric: true),
                  _metricRow(
                      'Deferred Backlog', '0 (Queue Stalled)', '1,850 buffered',
                      isBetter: true),
                  _metricRow('Worker Utilization', '100% (Crashing)',
                      '89% (Regulated)',
                      isBetter: true),
                  _metricRow(
                      'Compute Cost / Hour', '\$128.40', '\$38.20 (-70%)',
                      isBetter: true),
                ],
              ),
              const SizedBox(height: 20),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () => Navigator.of(context).pop(),
                  child: const Text('Close Replay Benchmark',
